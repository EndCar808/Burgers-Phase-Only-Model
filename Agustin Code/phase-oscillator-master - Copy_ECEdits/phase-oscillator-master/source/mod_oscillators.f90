MODULE mod_oscillators
	...
	INTEGER(KIND=ki) :: N, k0, n_max, n_bins, dur_norm, alpha_index
	...
	SUBROUTINE initialize_oscillators(a_N, a_k0, a_alpha, a_beta, a_n_max, a_n_bins, a_x_lim, a_alpha_index)
		USE mod_kind, ONLY: PI2
		USE mod_functions, ONLY: initialize_fft, omega_max_min, set_timescale
		USE omp_lib, ONLY: omp_get_wtime
		IMPLICIT NONE
		INTEGER(KIND=ki), INTENT(IN) :: a_N, a_k0, a_n_max, a_n_bins, a_alpha_index
		...
		file_name= get_file_name(a_N,a_k0,alpha_index)
...
WRITE(*, *) N, k0, alpha, beta
! 		OPEN(NEWUNIT=progress_unit,FILE='progress/progress_'// TRIM(file_name) //'.dat')
! 		90  FORMAT ('Doing N=2**',I8,', k0=2**',I5,', alpha=',f7.5,', beta=',f7.5,', n_max=',I5 &
! & ,', n_bins=',I5,', dur_norm=',I5,', x_lim=',f10.5)
! 		WRITE(progress_unit, 90 ) a_N,a_k0,alpha,beta, n_max, n_bins, dur_norm, x_lim
! 		WRITE( output_unit , 90 ) a_N,a_k0,alpha,beta, n_max, n_bins, dur_norm, x_lim
