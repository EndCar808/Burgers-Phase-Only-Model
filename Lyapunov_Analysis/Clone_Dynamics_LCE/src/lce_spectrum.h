...
double* pert_solver(double* phi, double* pertMat, double* amp, int* kx, fftw_plan fftw_plan_c2r, fftw_plan fftw_plan_r2c, int N, int k0,  int iters, int m, double pert, int pert_dir);
